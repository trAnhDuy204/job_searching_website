...
project/
├── backend/
│   ├── flask-api/        # Flask microservice
│   └── node-api/         # NodeJS microservice
├── frontend/             # ReactJS SPA
├── database/             # Cấu trúc CSDL PostgreSQL
├── README.md
```
...
> Cấu hình kết nối DB, JWT secret,... nằm trong `.env` các service tương ứng.
